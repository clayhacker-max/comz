...
class PARZE:
	...
	def CLI_PARSE():
		print (banners)
		_sazd = _PARSE.ArgumentParser(usage="comz.py [-m] -i <files> -c <Number> -r <Repeat> -o <Outfile>",description="{Compile Marshal} {c} Mr.Gaming | Sazxt thanks {Mr.Tr3v!0n} | Black Coder Crush",version="\tRelase Version Available 1.6 ~ ")
